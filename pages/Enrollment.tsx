...
import { Save, AlertCircle, CheckCircle, Loader2, ArrowLeft, Camera, Fingerprint, Scan } from 'lucide-react';
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (faceppAvailable) {
        ...
        const detectResult = await detectFace(capturedImage);
      ...
      <div className="max-w-5xl mx-auto p-4 md:p-8 pb-20">
        <div className="mb-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm">Register personnel with Face++ recognition.</p>
          </div>
        </div>
        ...
        {faceppAvailable && (
          <div className="bg-blue-950/30 border border-blue-900/50 rounded-xl p-3 mb-6 flex items-center gap-3">
            ...
            <p className="text-blue-300 text-sm">Face++ enabled - staff will be registered for instant recognition</p>
          </div>
        )}
